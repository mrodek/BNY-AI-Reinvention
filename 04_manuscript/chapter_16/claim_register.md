...
| CLM-006 | Once canonical products exist, the next architecture problem is not "what does the data mean?" but "how should intelligence be routed, governed, and enforced across trusted products?", which is why CH17 follows. | structural synthesis | supported | SRC-004, SRC-005, SRC-007 | Bridge into control plane |
