...
| --- | --- | --- | --- |
| RISK-001 | A control plane solves AI governance completely. | overclaim | The control plane is necessary but not sufficient; CH18 (observability) and the full runtime model in CH17 are also required |
