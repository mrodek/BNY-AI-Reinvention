...
- How should CH16 connect semantic foundation to the later control-plane and runtime chapters?
...
| SRC-004 | reviewed | CH15 Source Notes / Ontology Bridge | 04_manuscript/chapter_15/source_notes.md | Internal bridge from semantic foundation to implementation layer | Keeps CH16 tied tightly to the prior chapter |
...
- CH16 should argue that canonical data products are the implementation vehicle for ontology: shared meaning becomes reusable when it is packaged with ownership, interfaces, controls, and lineage.
...
- CH17 should follow naturally once the reader accepts that trustworthy products exist; the next question becomes how intelligence is routed, governed, and enforced across them.
...
- Need to bridge into CH17 without prematurely explaining the control plane.
...
- BNY sources were chosen first because CH16 needs to remain specific to BNY's architecture opportunity rather than become a generic data-platform essay.
