...
| --- | --- | --- | --- | --- | --- |
| CLM-001 | The ontology problem is not simply that financial data is fragmented across systems. It is that business concepts, events, and states often lack stable shared meaning across those systems. | conceptual framing | supported | SRC-004, SRC-005, SRC-006, SRC-011 | Important opening distinction for the chapter |
...
| CLM-003 | Financial-services standards efforts such as FIBO and the FINOS CDM exist because finance requires machine-readable, unambiguous shared meaning to support interoperability, reporting, and lifecycle processing. | factual synthesis | supported | SRC-006, SRC-009, SRC-010 | Keep phrasing practical rather than academic |
...
| CLM-005 | A useful enterprise ontology should cover entities, identifiers, relationships, lifecycle events, states, constraints, and ownership boundaries where cross-workflow reasoning matters most. | strategic interpretation | supported | SRC-006, SRC-007, SRC-008, SRC-009, SRC-010 | This is a practical design claim inferred from the standards and tooling evidence |
