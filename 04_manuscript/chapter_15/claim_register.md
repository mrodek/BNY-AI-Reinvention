...
| CLM-005 | A useful enterprise ontology should cover entities, identifiers, relationships, lifecycle events, states, constraints, ownership boundaries, and service-domain semantics where cross-workflow reasoning matters most. | strategic interpretation | supported | SRC-006, SRC-007, SRC-008, SRC-009, SRC-010, SRC-012, SRC-013, SRC-014, SRC-016 | This is a practical design claim inferred from the standards and tooling evidence |
