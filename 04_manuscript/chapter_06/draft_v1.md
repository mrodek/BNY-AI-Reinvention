...
This is also where terms like margin, collateral, and liquidity stop being abstract finance language and become concrete operating requirements. Margin is the buffer a participant has to post so the system has protection if exposures move against it or if completion is threatened. Collateral is the actual asset, usually cash or highly liquid securities, pledged to satisfy that requirement. Liquidity is the participant's ability to produce the necessary cash or financing on time when the infrastructure calls for it. Those are different ideas, but in live operations they collide quickly. If required margin rises, collateral has to be available. If collateral is tied up elsewhere, firms may need financing. If financing is slow or expensive, the pressure shows up in settlement readiness and risk management.^[SRC-011]^[SRC-012]^[SRC-015]
