...
Another is a funding or inventory problem created by compressed timelines. If faster settlement removes some of the time previously available for netting, financing, or securities positioning, a participant may need cash sooner or may need to have securities available earlier in the day than it expected. That does not automatically mean the trade will fail. It means the firm now has less room to solve the problem. Operations and treasury teams may have to find financing quickly, move collateral, or source securities fast enough to avoid a missed settlement.^[SRC-012]^[SRC-013]
