...
### CH03 - Low-Fidelity Trade Flow Sketch

Use this prompt to generate a rough pencil-drawn process-flow image for Chapter 3.
...
6. Custody / safekeeping / record-keeping layer
7. Retail investor's brokerage account shows the settled position and ownership records

Visually emphasize that execution is only the beginning and that the hidden infrastructure sits underneath the visible trade.
